  ...
  <div class="blog-details__aside">
    ...
    <div class="blog-details__buttons">
      <div v-for="button in buttons" class="blog-details__button">
        <label :data-id="button.id" @change="sortArticles"
          ><input
            :data-id="button.id"
            @click="filters"
...
export default {
  ...
  data() {
    return {
      ...
      //     secondsrc: "../assets/blog_kitchen_bottom.jpg",
      //   },
      // ],
      // articles: [
      //   {
      ...
      //     fourthpargth:
      //       "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
      //     secondsrc: "../assets/blog_building_2.jpeg",
      //   },
      //   {
      //     id: "architecture",
      //     title:
      //       "Our paper emphasizes the importance of the kitchen layout in facilitating consumers food hygiene practices.",
      ...
      //     secondpargth:
      //       "Embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary.",
      //     src: "../assets/blog_architecture.jpeg",
      //     alt: "photo",
      ...
      //     fourthpargth:
      //       "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
      //     secondsrc: "../assets/blog_architecture_2.jpeg",
      //   },
      //   {
      //     id: "kitchen-planning",
      ...
      //     secondpargth:
      //       "Embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary.",
      //     src: "../assets/kitchen_planning.jpeg",
      //     alt: "photo",
      //     quote: "The kitchen is the heart of the home.",
      //     subtitle:
      //       "Kitchens should be designed around whats truly important – fun, food, and life.",
      //     thirdpargth:
      //       "Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
      //     firstnumber: "1",
      //     secondnumber: "2",
      ...
      //     fourthpargth:
      //       "Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.",
      //     secondsrc: "../assets/kitchen_planning_2.jpeg",
      //   },
      // ],
      ...
      //   { id: "kitchen-planning", text: "Kitchen Planning" },
      // ],
    };
  },
};
